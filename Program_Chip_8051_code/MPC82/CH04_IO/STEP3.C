...
*硬體：SW1-3(POLED)ON及SW2-1~4(STEP)ON
***********************************************/
#include "..\MPC82.H"   //暫存器及組態定義
unsigned char run_Table[]={0x1,0x2,0x4,0x8};//驅動數碼

unsigned int code func_Table[] //步進馬達動作 
    = {1,30,100, //正轉,step=30,delay=0.1sec 
       3,1000,   //停止,delay=10sec
       2,20,100, //反轉,step=20,delay=0.1sec 
       3,2000,   //停止,delay=20sec 
       0};      //從頭開始  
