...
*       P0=LCD的Data，P30=RS，P31=RW，P32=EN
*****************************************/
...
void LCD_Disp8(unsigned long disp)  // LCD顯示8位數十進制數字
{
 if (disp>9999999) LCD_Data(disp / 10000000+'0');        //取出千萬位數字元到LCD顯示
 if (disp>999999) LCD_Data(disp % 10000000/1000000+'0');   //取出百萬位數字元到LCD顯示
 if (disp>99999) LCD_Data(disp % 1000000/100000+'0');     //取出十萬位數字元到LCD顯示
 if (disp>9999) LCD_Data(disp % 100000/10000+'0');		  //取出萬位數字元到LCD顯示
 if (disp>999) LCD_Data(disp % 10000/1000+'0');        //取出千位數字元到LCD顯示
 if (disp>99) LCD_Data(disp % 1000/100+'0');   //取出百位數字元到LCD顯示
 if (disp>9)LCD_Data(disp % 100/10+'0');     //取出十位數字元到LCD顯示
