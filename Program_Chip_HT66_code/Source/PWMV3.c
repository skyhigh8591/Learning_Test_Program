// PROGRAM	: PWMV3.c									2019.0701
// FUNCTION	: PTM Timer Mode for PWMs Generation(L/R)	By Steven
// Note		: Change to ESK300 Low Active LEDs
#include <HT66F2390.h>
#include "MyType.H"
const u8 PWM_TAB[] = {1,15,50,240};						//Duration Control
volatile u8 PWM[12],PWMBuf[12];
volatile u8 Period;
void Delayms(u16);
void main()
{	u8 i,temp,j;
	_wdtc=0xAF;											//Disable WDT			            	
	_pcc=0; _pc=0xFF;									//Turn off LEDs on Port C		            	
