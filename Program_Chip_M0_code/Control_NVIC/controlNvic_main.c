...
void EXTI0_1_IRQHandler(void)
{
	...
	printf("IRQ 5 interrupt\n\r");
	NVIC_SetPendingIRQ(EXTI2_3_IRQn);
	Delay(5000);
	printf("IRQ 5 int end\n\r");
}	
...
int main (void) {        // User application starts here
	...
	NVIC_SetPriority(SysTick_IRQn,0);          //優先度 0 最高，3最小
	Button_Init();
